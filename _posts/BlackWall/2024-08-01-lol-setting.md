...
- 추가 단축키 - 스킬과 소환사 주문 - 기타 - 스킬 레벨업 : Alt + QWER, 챔피언만 조준 : CapsLock, 즉시 + 자기 자신에게 시전 : Shift Q-R D-F, 본진 귀환 : V
- 추가 단축키 - 카메라 제어 - 자신을 중심으로 카메라 시야 설정 : Space, 카메라 잠금 전환 : `, 드래그 스크롤 : (지정 해제)
