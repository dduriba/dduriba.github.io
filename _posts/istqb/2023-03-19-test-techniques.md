...
<span style="background-color:rgb(237,220,195);">경험 기반 테스트 기법</span>은 <span style="background-color:rgb(242,213,214);">개발자, 테스터, 사용자의 경험을 활용하여 테스트를 설계, 구현, 실행한다. 이 기법은 블랙박스 및 화이트박스 테스트 기법과 결합해서 사용하는 경우가 많다.</span>
...
- <span style="background-color:rgb(237,220,195);">유효값(valid values)이란 컴포넌트나 시스템에 입력되는 값이다. 유효한 값을 포함하는 동등한 파티션을 “유효 동등 분할”이라고 한다.</span>
- <span style="background-color:rgb(237,220,195);">비유효값(invalid values)이란 컴포넌트나 시스템이 거부하는 값이다. 유효하지 않은 값을 포함하는 동등한 파티션을 “비유효 동등 분할”이라고 한다.</span>
