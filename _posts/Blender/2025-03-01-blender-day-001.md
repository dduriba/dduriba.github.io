...
<span class="color-keyword">화면 이동(Pan)</span> : Shift 키 홀드 + 마우스 휠 버튼 홀드 + 마우스 이동

<span class="color-keyword">줌 인/아웃</span> : Ctrl 키 홀드 + 마우스 휠 버튼 홀드 + 마우스 이동

<span class="color-keyword">모든 오브젝트들을 한눈에 보이게 하고 3D 커서 위치를 초기화</span> : Shift + C
