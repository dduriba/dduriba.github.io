...
<span class="pen-bold">Wise Offer</span>
...
<span class="pen-bold">Royce</span>
...
Royce is a feral animal - let him our of sight for one sec and he'll crush your windpipe like a beer can.
...
don't remember asking your opinon, p. 

Been in this biz 5 yrs so that makes me goddamn methuselah. 
...
<span class="pen-bold">Transports - LOA</span>
...
<span class="pen-bold">warning</span>
...
<span class="pen-bold">production floor</span>
...
Know what you're doing behind my back.
...
<span class="pen-bold">big deal</span>
...
brick - this is a big fuckin deal

get your guys together - everyone

production floor ... wating on you

## possible buyers - militech gear
{: .notice--success}

생산층 구역 컴퓨터 파일

bitch from the afterlife

dex deshawn (if wallet's as fat as he is)

mr.hands - no contact # atm
...
Stop contacting the mole!

We're in deep shit.

## (URGENT) MARKETING ISSUE
{: .notice--success}

생산층 구역 브릭 옆 방과 로이스 방 옆 위층 탈출 시작 부분 관리실에서 발견

<span class="pen-bold">(Urgent) Marketing Issue</span>
...
Mark, I still have a problem with the direction of this ad. It won't pass the focus groups with flying colors - if at all. What do we hope to achieve by advertising "milk?" I know you've seen the latest reports - even if we jack up nutrient content and tweak the consistency, we'll still lose to Biotechnica's alternatives. Our paste products already test worse with younger consumers. 

Besides, it's not even clear who the target audience is for this. You ARE aware most of our target sales are in urban markets, right? Unless you're playing off a sense of misplaced nostalgia or some reference I just don't get. 
...
<span class="pen-bold">only you guys know</span>
...
brick's been demoted to cage duty 

code's 9691 

keep it to your fucking selves

## Orgiatic - Product Vision Meeting Notes
{: .notice--success}

생산층 구역 브릭 옆 방 파일

Notes after presentation: 
- settled on the name "Orgiatic" - tested very well, mktg and PR are in favor 
...
## Orgiatic - Nutrition and Sales Approach Summary
{: .notice--success}
...
## Orgiatic - Promotional Brochure Draft
{: .notice--success}
...
<div class="cyberpunk-bg">
<span class="cyberpunk-violet pen-bold">Report #17345</span><br>
<span class="cyberpunk-cyan">
...
<div class="cyberpunk-bg">
<span class="cyberpunk-violet pen-bold">Report #17350</span><br>
<span class="cyberpunk-cyan">
...
<div class="cyberpunk-bg">
<span class="cyberpunk-violet pen-bold">Report #17355</span><br>
<span class="cyberpunk-cyan">
